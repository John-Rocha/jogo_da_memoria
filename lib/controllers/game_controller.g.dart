...
mixin _$GameController on GameControllerBase, Store {
  ...
  @override
  bool get jogadaCompleta => (_$jogadaCompletaComputed ??= Computed<bool>(
  ...
  late final _$venceuAtom = Atom(
    name: 'GameControllerBase.venceu',
    context: context,
  );
  ...
  late final _$perdeuAtom = Atom(
    name: 'GameControllerBase.perdeu',
    context: context,
  );
